...
.
.TH "CMAKE-VARIABLES" "7" "Oct 27, 2021" "3.21.4" "CMake"
.SH NAME
...
types.
.sp
See \fBCMAKE_BUILD_TYPE\fP for specifying the configuration with
...
.sp
This setting is also used by the \fBExternalProject\fP module
for internal calls to \fBfile(DOWNLOAD)\fP\&.
.sp
