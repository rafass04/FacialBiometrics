...
.
.TH "CMAKE-COMMANDS" "7" "Oct 27, 2021" "3.21.4" "CMake"
.SH NAME
...
.ft C
std::cout <<
  "<DartMeasurement type=\e"numeric/double\e" name=\e"score\e">28.3</DartMeasurement>"
  << std::endl;

std::cout <<
  "<DartMeasurement type=\e"text/string\e" name=\e"color\e">red</DartMeasurement>"
  << std::endl;

std::cout <<
  "<DartMeasurement type=\e"text/link\e" name=\e"CMake URL\e">https://cmake.org</DartMeasurement>"
  << std::endl;

std::cout <<
  "<DartMeasurement type=\e"text/preformatted\e" name=\e"Console Output\e">" <<
  "line 1.\en" <<
...
.ft C
std::cout <<
  "<DartMeasurementFile type=\e"image/jpg\e" name=\e"TestImage\e">" <<
  "/dir/to/test_img.jpg</DartMeasurementFile>" << std::endl;

std::cout <<
  "<DartMeasurementFile type=\e"image/gif\e" name=\e"ValidImage\e">" <<
  "/dir/to/valid_img.gif</DartMeasurementFile>" << std::endl;

std::cout <<
  "<DartMeasurementFile type=\e"image/png\e" name=\e"AlgoResult\e"> <<
...
.ft C
std::cout <<
  "<DartMeasurementFile type=\e"file\e" name=\e"MyTestInputData\e">" <<
